...
US_SNAPSHOT_MAPPING_INDEX_PATH = f"{US_TEMP_DATA_PATH}/41_snapshot_mapping_index"
...
US_REG_INPUT_COPY_LOG_PATH = f"{US_REG_DATA_PATH}/1_input_copy_log.csv"
US_REG_ORIGINAL_PATH = f"{US_REG_TEMP_DATA_PATH}/11_htm"
US_REG_XML_PATH = f"{US_REG_TEMP_DATA_PATH}/12_xml"
US_REG_REFERENCE_AREAS_PATH = f"{US_REG_TEMP_DATA_PATH}/13_reference_areas"
US_REG_REFERENCE_PARSED_PATH = f"{US_REG_DATA_PATH}/2_xml"
US_REG_HIERARCHY_GRAPH_PATH = f"{US_REG_DATA_PATH}/3_hierarchy_graph"
US_REG_CROSSREFERENCE_LOOKUP_PATH = f"{US_REG_TEMP_DATA_PATH}/31_crossreference_lookup"
US_REG_CROSSREFERENCE_EDGELIST_PATH = (
    f"{US_REG_TEMP_DATA_PATH}/32_crossreference_edgelist"
)
US_REG_AUTHORITY_EDGELIST_PATH = f"{US_REG_TEMP_DATA_PATH}/33_authority_edgelist"
US_REG_CROSSREFERENCE_GRAPH_PATH = f"{US_REG_DATA_PATH}/4_crossreference_graph"
US_REG_SNAPSHOT_MAPPING_INDEX_PATH = (
    f"{US_REG_TEMP_DATA_PATH}/41_snapshot_mapping_index"
)
...
US_REG_REFERENCE_PARSED_LOG_PATH = (
    f"{US_REG_HELPERS_PATH}/us_extract_reference_parsed.log"
)
...
DE_SNAPSHOT_MAPPING_INDEX_PATH = f"{DE_TEMP_DATA_PATH}/41_snapshot_mapping_index"
