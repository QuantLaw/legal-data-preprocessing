...
US_REG_CROSSREFERENCE_LOOKUP_PATH = f"{US_REG_DATA_PATH}/31_crossreference_lookup"
US_REG_CROSSREFERENCE_EDGELIST_PATH = f"{US_REG_DATA_PATH}/32_crossreference_edgelist"
US_REG_AUTHORITY_EDGELIST_PATH = f"{US_REG_DATA_PATH}/33_authority_edgelist"
