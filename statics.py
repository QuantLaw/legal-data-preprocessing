...
DE_RVO_CROSSREFERENCE_EDGELIST_PATH = f"{DE_RVO_TEMP_DATA_PATH}/32_crossreference_edgelist"
DE_RVO_CROSSREFERENCE_GRAPH_PATH = f"{DE_RVO_DATA_PATH}/4_crossreference_graph"
DE_RVO_SNAPSHOT_MAPPING_EDGELIST_PATH = f"{DE_RVO_DATA_PATH}/5_snapshot_mapping_edgelist"
